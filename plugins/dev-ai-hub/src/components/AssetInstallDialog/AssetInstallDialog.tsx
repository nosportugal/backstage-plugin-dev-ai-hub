...
export function AssetInstallDialog({ assetId, onClose }: AssetInstallDialogProps) {
  ...
  const handleAddToVSCode = (protocol: 'vscode' | 'vscode-insiders' = 'vscode') => {
          ...
          >
            ...
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'nowrap' }}>
              {tool === 'github-copilot' && !isZipSkill && canAddToVSCode && (
                ...
                >
                  <Button
                    startIcon={<img src="https://code.visualstudio.com/favicon.ico" alt="" width={14} height={14} />}
                ...
                >
                  {({ TransitionProps }) => (
                    <Grow {...TransitionProps}>
                      <Paper elevation={4}>
                        <ClickAwayListener onClickAway={() => setVsCodeMenuOpen(false)}>
                          <MenuList dense>
                            <MenuItem onClick={() => handleAddToVSCode('vscode')}>
                              Add to VS Code
                            </MenuItem>
                            <MenuItem onClick={() => handleAddToVSCode('vscode-insiders')}>
